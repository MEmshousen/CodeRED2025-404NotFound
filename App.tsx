...
export default function App() {
  ...
  if (view === 'teacher') {
    return <TeacherDashboard onBack={() => setView('home')} />;
  }
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-8 py-16 relative z-10">
        ...
        >
          ...
          >
            A real-time platform powered by <span className="text-purple-600 font-semibold">AI</span> for students to anonymously share confusion points
          </motion.p>
        </motion.div>
          ...
          >
            <Card className="border-2 border-blue-300 hover:border-blue-500 transition-all hover:shadow-2xl backdrop-blur-sm bg-white/90 relative overflow-hidden h-full">
              ...
              <CardHeader className="relative z-10">
                ...
                <CardDescription>
                  Create a room, share the ID with students, and get real-time insights into what's
                  confusing your class
                </CardDescription>
              </CardHeader>
          ...
          >
            <Card className="border-2 border-green-300 hover:border-green-500 transition-all hover:shadow-2xl backdrop-blur-sm bg-white/90 relative overflow-hidden h-full">
              ...
              <CardHeader className="relative z-10">
                ...
                <CardDescription>
                  Join your class room and anonymously share topics you're confused about
                </CardDescription>
              </CardHeader>
              <CardContent className="relative z-10">
                <ul className="space-y-3 mb-6 text-sm text-gray-700">
